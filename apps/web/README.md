...
Once installed, navigate to the root of the Nova repo and run `yarn dev:server` (this runs `npx @langchain/langgraph-cli dev --port 54367`).
...
After your LangGraph server is running, execute the following command to start the Nova app:
